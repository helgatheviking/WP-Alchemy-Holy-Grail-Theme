...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php
			...
			// Display the alchemy text boxes
			...
			if( isset( $simple_textarea ) ){
				echo '<h2>' . __( 'Simple Text Area', 'wpalchemy-grail' ) . '</h2>';
				$simple_textarea->the_meta(); 
				echo apply_filters( 'meta_content', $simple_textarea->get_the_value( 'test_editor' ) );
			}
			
			if( isset( $repeating_textareas ) ){
				echo '<h2>' . __( 'Repeating Text Areas', 'wpalchemy-grail' ) . '</h2>';
